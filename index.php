...
<body>
  ...
  <section class="home" id="home">
    ...
    <div class="content">
      ...
      <a href="" class="btn">Welcome to EasyTour</a><br>
      <a class="btn">Procced to booking and book a  place  of your choice <br> where you wanna visit this time round</a>
    ...
    <div class="video-container">
      <video src="images/vid-44.mp4" id="video-slider" loop autoplay muted></video>
    </div>
...
<!-- book section starts -->
  <section class="book" id="book">
    ...
    <div class="row">
      ...
      <form action="book_process.php" method="POST" id="signup" novalidate>
        <div class="inputBox">
        ...
        <div class="inputBox">
          ...
          <input type="number" name="tourist" id="tourist" placeholder="number of guests">
        </div>
        <div class="inputBox">
          <h3>Arriving date</h3>
...
<!-- contact section starts -->
  <section class="contact" id="contact">
    ...
    <form action="message_process.php" method="post" data-aos="zoom">
      ...
      <div class="inputBox">
        <input type="number" name="tourist" id="tourist" placeholder="number" data-aos="fade-up">
        <input type="text" name="subject" id="subject" placeholder="subject" data-aos="fade-up">
      </div>
